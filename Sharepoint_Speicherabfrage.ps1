Connect-SPOService -Url https://mertensextern-admin.sharepoint.com -Credential d.artz@mertens.ag
...
$url = 'https://mertensextern-admin.sharepoint.com'

#Specify a folder path to output the results into
$path = '.\'

#SMTP details
$Smtp = 'mail.mertens.ag'
$From = 'd.artz@mertens.ag'  
$To = 'd.artz@mertens.ag'
